...
exports.run = async (client, message, args) => {
  ...
  const Durum = user.presence.status;
            ...
            const durm = (Durum == "online" ? (client.emojis.get('497040317552394241') + "Çevrimiçi") : (Durum == "offline" ? (client.emojis.get('497041097101410307') + "Çevrimdışı") : (Durum == "idle" ? (client.emojis.get('497040874010837012') + "Boşta") : (Durum == "dnd" ? (client.emojis.get('497040545957543936') + "Rahatsız Etmeyin") : ("Bilinmiyor/bulunamadı.")))))
